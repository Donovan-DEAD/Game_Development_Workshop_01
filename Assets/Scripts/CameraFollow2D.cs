...
public class CameraFollow2D : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 offset = Vector2.zero; // shift the framing, e.g. (0, 1) to seemore above the player
    [Header("Axes")]
[SerializeField] private bool followX = true;
    [SerializeField] private bool followY = true;
    [SerializeField] private float fixedY = 0f; // used when followY is false
    [Header("Smoothing")]
    [SerializeField] private float smoothTime = 0.2f; // lower = snappier. SmoothDamp is frame-ratent.
    [Header("Dead Zone")]
